...
public class SizeComparatorTest {
    ...
    @Test
    public void SizeComparatorSortDirectories() {
        ...
        Collections.sort(dirs, (FSElement o1, FSElement o2) ->  o1.getSize() > o2.getSize() ? 1 : (o1.getSize() < o2.getSize()) ? -1 : 0);
        assertSame(root.getName(), dirs.get(0).getName());
        assertArrayEquals(expected, dirs.toArray());
    }

    @Test
    public void SizeComparatorSortFiles() {
        ...
        Collections.sort(files, (FSElement o1, FSElement o2) ->  o1.getSize() > o2.getSize() ? 1 : (o1.getSize() < o2.getSize()) ? -1 : 0);
        assertSame(b.getName(), files.get(0).getName());
        assertArrayEquals(expected, files.toArray());
    }

    @Test
    public void testgetChildrenSizeComparator() {
        FSElement[] expected = { Apps, home };
        Directory directory = root;
        List<FSElement> element = directory.getChildren((FSElement o1, FSElement o2) ->  o1.getSize() > o2.getSize() ? 1 : (o1.getSize() < o2.getSize()) ? -1 : 0);
        assertArrayEquals(expected, element.toArray());
    }

    @Test
    public void testgetSubDirectoriesSizeComparator() {
        Directory[] expected = {code};
        List<Directory> element = home.getSubDirectories((FSElement o1, FSElement o2) ->  o1.getSize() > o2.getSize() ? 1 : (o1.getSize() < o2.getSize()) ? -1 : 0);
        assertArrayEquals(expected, element.toArray());
    }

    @Test
    public void testgetFilesSizeComparator() {
        File[] expected = { c,d };
        List<File> files = code.getFiles((FSElement o1, FSElement o2) ->  o1.getSize() > o2.getSize() ? 1 : (o1.getSize() < o2.getSize()) ? -1 : 0);
        assertArrayEquals(expected, files.toArray());
    }
