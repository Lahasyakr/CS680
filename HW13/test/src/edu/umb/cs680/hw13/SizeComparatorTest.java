...
import edu.umb.cs680.hw13.fs.comparator.SizeComparator;
...
public class SizeComparatorTest {
    ...
    public void SizeComparatorSortDirectories() {
        ...
        Collections.sort(dirs, new SizeComparator());
    ...
    public void testgetChildrenSizeComparator() {
        ...
        List<FSElement> element = directory.getChildren(new SizeComparator());
    ...
    public void testgetSubDirectoriesSizeComparator() {
        ...
        List<Directory> element = home.getSubDirectories(new SizeComparator());
        assertArrayEquals(expected, element.toArray());
    }
    ...
    public void testgetFilesSizeComparator() {
        File[] expected = { c,d };
        List<File> files = code.getFiles(new SizeComparator());
        assertArrayEquals(expected, files.toArray());
    }
